...
<html lang="en">
    <head>
        ...
        <title>Zacharia Resume</title>
        <link rel="icon" type="image/x-icon" href="assets/img/profpic.jpeg" />
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                ...
                <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="assets/img/profpic.jpeg" alt="..." /></span>
            </a>
        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    <h1 class="mb-0">
                        Zacharia
                        <span class="text-primary">Njiraini</span>
                    </h1>
                    ...
                    <p class="lead mb-5">A technology professional with a passion for removing technological barriers of entry for startups and small-scale businesses. I have experience in network engineering and system administration. Interested in AWS, Azure, GCP, Python, SQL, Web Development, Data Science and Blockchain.<br>
                        ...
                        <a target="_blank" class="social-icon" href="https://twitter.com/zaq_in_nai"><i class="fab fa-twitter"></i></a>
<!--                    <a class="social-icon" href="#!"><i class="fab fa-facebook-f"></i></a>-->
                ...
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">Web Developer Trainee</h3>
                            <div class="subheading mb-3">Emobilis</div>
                            <p>Involved in a Web Development bootcamp. I worked on projects that involved HTML5, CSS3, Bootstrap.</p>
                        </div>
            ...
            <section class="resume-section" id="education">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">Emobilis</h3>
                            <div class="subheading mb-3">Web Developer Explorer</div>
